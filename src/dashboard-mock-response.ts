...
export enum ElementType { 'DATA_POINT', 'DATA_SET' } 
...
export const newLayoutResponse: LayoutResponse = {
...
export const backendDataResponse: FullDataResponse = {
  dataPoints: {
